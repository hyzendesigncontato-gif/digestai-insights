          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 rounded-xl bg-muted/50 border border-border">
              <p className="text-sm text-muted-foreground text-center">
                <span className="font-medium text-foreground">Não tem uma conta?</span>
                <br />
                Seus dados de acesso foram enviados por e-mail após a compra do DigestAI.
              </p>
            </div>
          </CardContent>
        </Card>
